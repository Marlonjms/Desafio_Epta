...
2. Agora, crie um arquivo chamado .env na raiz da pasta vistoria-api e siga as seguintes configurações:
...
1.front-end, instale as dependências necessárias:
cd vistoria-web
npm install

2. Variáveis ​​de Ambiente
Crie um arquivo .envna raiz do front-end para apontar para a API:
...
Obrigado.😃
link: https://drive.google.com/file/d/1JBALLSVMZNQOEYU5hh8NhdRZP_SbNv71/view?usp=sharing
